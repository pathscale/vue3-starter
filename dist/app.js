...
(function () {
    ...
    ***************************************************************************** */
    ...
    var script = {
      name: 'App',
      setup: () => {
        const state = dist.useState({ foo: 1, bar: 1 });
    ...
    const _hoisted_1 = { class: "container py-6 px-6" };
    const _hoisted_2 = /*#__PURE__*/createVNode("h1", { class: "title is-1" }, " Effect test ", -1 /* HOISTED */);
      ...
      return (openBlock(), createBlock("div", _hoisted_1, [
        ...
        createVNode("div", _hoisted_3, [
          createVNode("button", {
            ...
            onClick: _cache[1] || (_cache[1] = $event => (_ctx.increment('foo')))
          }, " foo += 1 "),
          createVNode("button", {
            class: "button is-warning",
            onClick: _cache[2] || (_cache[2] = $event => (_ctx.increment('bar')))
          }, " bar += 1 ")
        ]),
        createVNode("p", null, " foo is " + toDisplayString(_ctx.state.foo) + " and bar is " + toDisplayString(_ctx.state.bar), 1 /* TEXT */)
      ]))
    }
